 ...
 */
package net.anei.cadpage.providers;
...
public class MmsBodyProvider extends ContentProvider {
  private static final String CONTENT_URI_STRING = "content://net.anei.cadpage.provider.securesms.mms/mms";
  ...
  static {
    ...
    URI_MATCHER.addURI("net.anei.cadpage.provider.securesms.mms", "mms/#", SINGLE_ROW);
  }
  ...
  private File getFile(Uri uri) {
    ...
    return new File(Objects.requireNonNull(getContext()).getCacheDir(), id + ".mmsbody");
  }

  @Override
  public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode) throws FileNotFoundException {
    Log.i("openFile(" + uri + ", " + mode + ")");

    switch (URI_MATCHER.match(uri)) {
    case SINGLE_ROW:
      Log.i("Fetching message body for a single row...");
      ...
      Log.i("returning file " + tmpFile.getAbsolutePath());
